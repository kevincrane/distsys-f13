...
public class Point2DCentroid extends Point2D implements Centroid {
    ...
    public List<Centroid> calculateAllCentroidsParallel(List<DataPoint> points, int numClusters) {
        ...
        try {
            ...
            MPI.COMM_WORLD.Allreduce(totalX, 0, totalX, 0, numClusters, MPI.DOUBLE, MPI.SUM);
            MPI.COMM_WORLD.Allreduce(totalY, 0, totalY, 0, numClusters, MPI.DOUBLE, MPI.SUM);
            MPI.COMM_WORLD.Allreduce(numCoords, 0, numCoords, 0, numClusters, MPI.INT, MPI.SUM);
